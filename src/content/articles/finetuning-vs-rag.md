...
![خط زمانی پیش‌آموزش، Fine-tuning و Prompting با جداسازی آموزش از زمان اجرا](/source/llm-for-humans/images/vis-23-llm-lifecycle.png)
...
![مسیر داده خام، پاک‌سازی، جداسازی Train و Test، آموزش LoRA، ارزیابی، مقایسه و دیپلوی](/source/llm-for-humans/images/vis-24-fine-tuning-roadmap.png)
...
![درخت تصمیمی که دانش تازه رو به RAG، رفتار و مهارت رو به Fine-tuning و نیاز مشترک رو به ترکیب هر دو وصل می‌کنه](/source/llm-for-humans/images/vis-25-fine-tuning-vs-rag-decision.png)
