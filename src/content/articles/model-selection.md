...
![مقایسه مدل بسته و مدل وزن‌باز از نظر کنترل، هزینه و حریم خصوصی با گزینه ترکیبی](/source/llm-for-humans/images/vis-45-closed-vs-open-weight-models.png)
...
![نگاشت سه نوع کار به مدل چتی، استدلالی و بلادرنگ](/source/llm-for-humans/images/vis-46-chat-reasoning-realtime.png)
...
![پرامپت کوتاه با صورت مسئله و قیدها برای مدل استدلالی، همراه تنظیم تلاش استدلال و بررسی جواب](/source/llm-for-humans/images/vis-47-reasoning-model-prompting.png)
...
![معیارهای انتخاب مدل که از کار واقعی به آزمون، مدل اصلی، fallback و بازبینی دوره‌ای می‌رسن](/source/llm-for-humans/images/vis-30-model-selection-path.png)
