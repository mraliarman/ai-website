...
![پشته‌ای از سیستم، تاریخچه و پیام جدید که وارد مدل می‌شه و جواب تازه به تاریخچه برمی‌گرده](/source/llm-for-humans/images/vis-08-message-stack.png)
...
![رشد پشته تاریخچه در چند نوبت و سه راه‌حل پیام‌های اخیر، خلاصه و حافظه خارجی](/source/llm-for-humans/images/vis-09-conversation-context-growth.png)
...
![دو خط زمانی که پاسخ یک‌جا در پایان و پاسخ استریمینگ به‌صورت تدریجی ظاهر می‌شه](/source/llm-for-humans/images/vis-10-streaming-vs-buffered.png)
...
![اپی که از راه گیت‌وی، کش معنایی و مسیریاب به مدل اصلی، پشتیبان یا موتور اجرا وصل می‌شه](/source/llm-for-humans/images/vis-11-production-llm-architecture.png)
