...
![مسیر پرسش از امبدینگ و پایگاه برداری تا تکه‌های مرتبط، ترکیب کانتکست و پاسخ LLM](/source/llm-for-humans/images/vis-27-simple-rag-architecture.png)
...
![سه روش Chunking و مسیر بازیابی کلمه‌ای و برداری تا Hybrid، Reranker و نتیجه‌های برتر](/source/llm-for-humans/images/vis-28-rag-retrieval-strategies.png)
...
![مسیر ارزیابی RAG با چهار معیار وفاداری، ارتباط پاسخ، دقت نتایج بازیابی و پوشش اطلاعات لازم](/source/llm-for-humans/images/vis-34-rag-evaluation.png)
